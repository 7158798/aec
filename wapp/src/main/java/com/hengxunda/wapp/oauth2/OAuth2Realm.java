...
//    private ShiroCustomMapper shiroCustomMapper;
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        String json = iStringRedisService.get(RedisConstant.wapp_token + _token);
...
//        }
        ...
        iStringRedisService.set(RedisConstant.wapp_token+_token,json,TOKENEXPIRETIME, TimeUnit.HOURS);
